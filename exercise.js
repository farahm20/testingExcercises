...
// Här är de krav som funktionen ska uppfylla:
...
// function calculateInterest(interest, years) { /* TODO */ }
// // Example usage:
...
function test_forBadInterest_shouldThrowException(){
    ...
    try {
        calculateInterest(interest, years);
        throw new Error('Did not throw an error for bad value interest!');
    }catch {
        // function acted according to requirement
        //success
